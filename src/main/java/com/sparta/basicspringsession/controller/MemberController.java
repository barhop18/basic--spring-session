...
public class MemberController {
    ...
    @PostMapping("/members")
    public ResponseEntity<MemberSaveResponseDto> saveMember(@RequestBodyMemberSaveRequestdto requestDto) {
        return ResponseEntity.ok(meberService.saveMember(requestDto));
    }
